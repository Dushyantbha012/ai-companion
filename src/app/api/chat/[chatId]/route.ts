...
export async function POST(
  ...
  try {
    ...
    const prompt = `
        ...
        ${companion.instruction} andh here is an example conversation to tell you how ${companion.name} speaks : ${companion.seed}
        ...
        ONLY ANSWER WHAT IS ASKED AT LAST NOT THE PREVIOUS QUESTIONS. Talk as if you are ${companion.name}:
        `;
